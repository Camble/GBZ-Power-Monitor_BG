...
# source: https://github.com/Camble/GBZ-Power-Monitor_BG
...
shutdownVideo  = "~/GBZ-Power-Monitor_BG/lowbattshutdown.mp4" # use no space or non-alphanum characters
lowalertVideo  = "~/GBZ-Power-Monitor_BG/lowbattalert.mp4"    # use no space or non-alphanum characters
playerFlag     = 0

GPIO.setmode(GPIO.BCM)
GPIO.setup(batteryGPIO, GPIO.IN)
